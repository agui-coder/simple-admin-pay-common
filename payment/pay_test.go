...
import (
	...
	"github.com/agui-coder/simple-admin-pay-common/payment/weixin"
...
func TestCreateWxPayClient(t *testing.T) {
	...
	err := factory.CreateOrUpdatePayClient(1, model.WxPub, buildWxClientConfig())
	if err != nil {
		log.Fatal(err.Error())
	}
...
func TestCreateAliPayClient(t *testing.T) {
	...
	err := factory.CreateOrUpdatePayClient(2, model.AlipayPc, buildAliClientConfig())
	if err != nil {
		log.Fatal(err.Error())
	}
